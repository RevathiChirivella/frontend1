    ...
    return (
        ...
        <div className="container">
            <div className="row g-10">
                <div className="col-md-1 col-lg-10 order-md-last">
                    <h4 className="d-flex justify-content-between align-items-center mb-3">
                        <span className="text-primary mt-3">Your cart</span>
                        ...
                        <form className="needs-validation" novalidate="">
                            ...
                            {/* <div className="form-check">
                                <input type="checkbox" className="form-check-input" id="save-info">
                                    <label className="form-check-label" for="save-info">Save this information for next time</label></input>
                            </div> */}
                            ...
                            <hr className="my-4" />
                             ...
                             <button className="w-100 btn-border-black btn-lg" type="submit" ><NavLink to="/payment">Confirm Payment</NavLink></button>
